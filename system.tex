...
\begin{figure*}[!ht]
\centering
\subfloat[Initial ROI] {\includegraphics[width=4.2in]{plots/rec_mv.jpg}}\\
\subfloat[Movement with change of sensor data] {\includegraphics[width=4.2in]{plots/rec_mv1.jpg}}\\
\subfloat[Movement with change of sensor data] {\includegraphics[width=4.2in]{plots/rec_mv2.jpg}}
...
\begin{figure*}[!ht]
\centering
\subfloat {\includegraphics[width=4.2in]{plots/rec_enl.jpg}}\\
\subfloat {\includegraphics[width=4.2in]{plots/rec_enl1.jpg}}
