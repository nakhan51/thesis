...
Figure \ref{f:red} shows the video frame with red traffic signal light and figure \ref{f:green} shows the frame with green traffic signal light.
...
Figure \ref{f:red_fil} shows the filtering output with a red traffic light and figure \ref{f:green_fil} shows the filtering output with green traffic lights.
...
Figure \ref{f:red_cir} shows the red traffic light detection.
...
Figure \ref{f:green_cir} shows the green traffic light detection output with Hough transform method.
